...
pub use signature::{VerifiedManifest, verify_manifest};
pub use trust::{TrustedKey, TrustedKeyRegistry, key_id_for_public_key};
...
pub const DETACHED_SIGNATURE_BYTES: usize = 86;
pub const SIGNING_DOMAIN: &[u8] = b"AIHELPER-RELEASE-MANIFEST-V1\0";
