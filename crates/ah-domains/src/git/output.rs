...
use ah_output::{Emitter, TextFormatter, TextStyle, git_status_style, render_semantic_count};

use crate::git::domain::{
...
fn render_changed_entry(
    entry: &crate::git::domain::ChangedEntry,
...
fn render_commit_file(file: &crate::git::domain::CommitFile, formatter: TextFormatter) -> String {
...
mod tests {
    ...
    use ah_output::{Emitter, GlobalOptions, OutputMode, TextFormatter};
