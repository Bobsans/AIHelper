use crate::search::domain::{SearchFilesOutput, SearchResult, SearchTextOutput};
...
fn render_text_matches(
    matches: &[crate::search::domain::TextMatch],
    context_lines: usize,
...
mod tests {
    ...
    use crate::search::domain::{ContextLine, TextMatch};
