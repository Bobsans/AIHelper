...
use ah_output::{Emitter, GlobalOptions, OutputMode};
use ah_secrets::{
...
mod tests {
    ...
    use ah_secrets::{KeyProvider, SecretKind, VaultError, VaultStore};

    use super::{SecretsCommand, apply, validate_setup_url};
    use crate::secrets::output::{render_json, render_setup_output, render_text};
