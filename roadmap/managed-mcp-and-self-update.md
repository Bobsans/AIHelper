...
- [x] Реализовать одноразовый `ah upgrade --rollback`.
- [x] Сохранять предыдущую рабочую версию в
      `%APPDATA%\AIHelper\backup\<INSTALLATION_ID>`.
- [x] Хранить один постоянный backup до следующего успешного обновления.
- [x] Ротировать backup только после успешной активации новой версии.
- [x] Сохранять старый постоянный backup, если новое обновление завершилось
