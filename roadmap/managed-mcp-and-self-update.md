...
Для завершения этапа 1 ещё нужны финальные lifecycle-проверки, включая активные
jobs и целевые MCP-клиенты. Управляемая фоновая установка и self-update остаются
запланированными.
